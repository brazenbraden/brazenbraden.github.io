...
var addComment = function() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    fetch(this.getAttribute('action'), {
      ...
      function (data) {
        if (data.ok) {
          showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/brazenbraden/brazenbraden.github.io/pulls">pending</a>. It will appear when approved.');
          form.reset();
          form.doReset();
        } else {
